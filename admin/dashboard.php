...
$totalRentedCarsQuery = "SELECT COUNT(*) as total FROM rentedcar WHERE rent_status = 'rented'"; 
$result = $conn->query($totalRentedCarsQuery);
$totalRentedCars = $result->fetch_assoc()['total'];


$pendingRequestsQuery = "SELECT COUNT(*) as total FROM payment WHERE payment_status = 'pending'"; 
